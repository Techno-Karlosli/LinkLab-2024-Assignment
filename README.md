...
```json
{
    ...
    ".text": [
        "🏷️: helper 24", // 局部符号
        "🔢: f3 0f 1e fa 55 48 89 e5 89 7d fc 8b 15", // 机器码
        "❓: .rel(message - 4)", // 需要重定位
        "🔢: 8b 45 fc 01 d0 5d c3", // 机器码
        "📤: main 20", // 全局符号
        "🔢: f3 0f 1e fa 55 48 89 e5 bf 2a 00 00 00 e8 d6 ff", // 机器码
        "🔢: ff ff 5d c3" // 机器码
    ],
    ".data": [
        "📤: message 8", // 全局符号
...
- 地址：符号在其所在段中的偏移量
- 类型：表示符号的类型和位置
  - 大写（T、D、B、R）：全局符号，分别表示在代码段、数据段、BSS段、只读数据段
  - 小写（t、d、b、r）：局部符号，分别表示在代码段、数据段、BSS段、只读数据段
  - W、V：弱符号，分别表示在代码段、还是在数据段或BSS段
- 名称：符号的名字
...
那么：
```
偏移量 = 0x4000A0 - (0x400034 + 5) = 0x6B
```

所以 `call` 指令会变成：
```
E8 6B 00 00 00   ; call add
```
...
┡━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━╇━━━━━━━╇━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━┩
│ nm Tool Test                         │  PASS  │ 0.05s │ 10.0/10.0 │ All steps completed │
│ Single File Test                     │  PASS  │ 0.04s │ 10.0/10.0 │ All steps completed │
│ Absolute Addressing Test             │  PASS  │ 0.04s │ 10.0/10.0 │ All steps completed │
│ Absolute + Relative Addressing Test  │  PASS  │ 0.09s │ 10.0/10.0 │ All steps completed │
│ Position Independent Executable Test │  PASS  │ 0.18s │ 10.0/10.0 │ All steps completed │
│ Strong Symbol Conflict Test          │  PASS  │ 0.09s │ 10.0/10.0 │ All steps completed │
│ Weak Symbol Override Test            │  PASS  │ 0.09s │ 10.0/10.0 │ All steps completed │
│ Multiple Weak Symbol Warning         │  PASS  │ 0.11s │ 10.0/10.0 │ All steps completed │
│ Local Symbol Access Test             │  PASS  │ 0.08s │ 10.0/10.0 │ All steps completed │
│ 64-bit Absolute Relocation Test      │  PASS  │ 0.06s │ 10.0/10.0 │ All steps completed │
│ Section Permission Control Test      │  PASS  │ 0.21s │ 10.0/10.0 │ All steps completed │
└──────────────────────────────────────┴────────┴───────┴───────────┴─────────────────────┘

╭─────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│ Total Score: 110.0/110.0 (100.0%)                                                                               │
╰─────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
```
